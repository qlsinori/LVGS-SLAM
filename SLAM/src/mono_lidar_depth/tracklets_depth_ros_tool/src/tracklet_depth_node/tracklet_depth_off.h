...
class TrackletDepth {
    ...
    using Subscriber3dgs = message_filters::Subscriber<sensor_msgs::Image>;
    ...
    using Policy3 = message_filters::sync_policies::
    ApproximateTime<Cloud, matches_msg_ros::MatchesMsg, CameraInfo, sensor_msgs::Image>;
...
private:
    ...
    void callback3dgs(const Cloud::ConstPtr& cloud_in,
                          const matches_msg_ros::MatchesMsgConstPtr& tracklets_in,
                          const CameraInfo::ConstPtr& camInfo,
                          const sensor_msgs::Image::ConstPtr& img);
    /*
...
public: // attributes
    ...
    Cloud::ConstPtr _combined_cloud_last_frame;
    
    Mono_Lidar::GroundPlane::Ptr groundPlaneLast_;
    Mono_Lidar::GroundPlane::Ptr combined_groundPlaneLast_;
