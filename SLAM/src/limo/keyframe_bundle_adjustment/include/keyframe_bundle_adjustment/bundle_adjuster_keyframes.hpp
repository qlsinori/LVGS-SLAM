...
public: // methods
    ...
    */
    ...
    void activateDelayedMeasurements(TimestampNSec current_timestamp_ns);
...
public:
    ...
    /// If true (default), add pose/motion prior residuals: inter-frame translation scale
    /// (PoseRegularization), ground-plane motion term, and speed regularization in adjustPoseOnly.
    bool use_pose_prior_residuals_{true};
